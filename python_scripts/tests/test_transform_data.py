...
from transform_data import (
    strip_commas_from_api_response,
    sensor_fact_data_to_long_format,
)
...
class MyTest(unittest.TestCase):
    ...
    def test_sensor_fact_data_to_long_format(self):
        ...
        data = {
            ...
            "HardwareID": 890001,
            "SensorID": 20890001,
            "SurveyDeviceID": 127717,
            "TriggerDate": "2018-04-25",
            "t0000": -1,
            "t0010": 1,
            "t0020": -1,
            "t0030": -1,
        ...
        long_format_0 = {
            "SurveyDeviceID": 127717,
            "sensor_value": -1,
            "obs_datetime": "2018-04-25 00:00:00",
        }
        long_format_1 = {
            "SurveyDeviceID": 127717,
            "sensor_value": 1,
            "obs_datetime": "2018-04-25 00:10:00",
        }
        long_format_last = {
            "SurveyDeviceID": 127717,
            "sensor_value": 0,
            "obs_datetime": "2018-04-25 23:50:00",
        }
